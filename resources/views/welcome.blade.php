...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/18-08-2020/traversal-liberty-demo_Free/156905689/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Mar 2024 20:44:52 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- google fonts -->
    <link href="http://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600;700&amp;display=swap"
        rel="stylesheet">
...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
      ...
      <a class="navbar-brand" href="#index.html">
          <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                    ...
                    {{-- <div class="d-lg-block d-none">
                        <a href="/login" class="btn btn-style btn-secondary">Login</a>
                    </div> --}}
                    @if (Auth::check())                        
                    ...
                    @else
                    <div class="d-lg-block d-none">
                        <a href="/signin" class="btn btn-style btn-secondary">Login</a>
                    </div>
                    @endif
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex below-section justify-content-between align-items-center pt-4 mt-5">
                            <div class="columns text-lg-left text-center">
                                <p>&copy; 2020 Traversal. All rights reserved.Design by <a
        ...
        <script>
            (function() {
                ...
                var js =
                    "window['__CF$cv$params']={r:'86704d670edf6f45',t:'MTcxMDg4MTA4Ny4wNDkwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/956dacbeead0/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
    ...
    <!-- Mirrored from p.w3layouts.com/demos_new/template_demo/18-08-2020/traversal-liberty-demo_Free/156905689/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Mar 2024 20:45:12 GMT -->
